"""autogenerated by genpy from seagull_autopilot_msgs/AutopilotGimbalPayload.msg. Do not edit."""
import sys
...
class AutopilotGimbalPayload(genpy.Message):
  _md5sum = "adb78e05c9cc6ce2e481f3c98b9ce89c"
  _type = "seagull_autopilot_msgs/AutopilotGimbalPayload"
...
"""
  __slots__ = ['header','len','data']
  _slot_types = ['seagull_commons_msgs/SeagullHeader','uint32','uint8[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(AutopilotGimbalPayload, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_HI.pack(_x.header.vehicleId, _x.len))
      _x = self.data
      length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.header.vehicleId, _x.len,) = _struct_HI.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end

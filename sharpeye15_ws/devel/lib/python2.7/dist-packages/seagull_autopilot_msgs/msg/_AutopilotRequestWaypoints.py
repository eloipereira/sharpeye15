"""autogenerated by genpy from seagull_autopilot_msgs/AutopilotRequestWaypoints.msg. Do not edit."""
import sys
...
class AutopilotRequestWaypoints(genpy.Message):
  _md5sum = "8bfd618ea4ba888bfa009a9932fe8f4b"
  _type = "seagull_autopilot_msgs/AutopilotRequestWaypoints"
...
"""
  __slots__ = ['header']
  _slot_types = ['seagull_commons_msgs/SeagullHeader']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(AutopilotRequestWaypoints, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_H.pack(self.header.vehicleId))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.header.vehicleId,) = _struct_H.unpack(str[start:end])
      return self

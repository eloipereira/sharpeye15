"""autogenerated by genpy from seagull_autopilot_msgs/AutopilotTrack.msg. Do not edit."""
import sys
...
class AutopilotTrack(genpy.Message):
  _md5sum = "92b29beb22b2471f3f315f2cfd63a06c"
  _type = "seagull_autopilot_msgs/AutopilotTrack"
...
"""
  __slots__ = ['header','to','go_to']
  _slot_types = ['seagull_commons_msgs/SeagullHeader','int8','int8']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(AutopilotTrack, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_H2b.pack(_x.header.vehicleId, _x.to, _x.go_to))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.header.vehicleId, _x.to, _x.go_to,) = _struct_H2b.unpack(str[start:end])
      return self

"""autogenerated by genpy from seagull_autopilot_msgs/AutopilotUserAction.msg. Do not edit."""
import sys
...
class AutopilotUserAction(genpy.Message):
  _md5sum = "3fa4894e20b298a9316812ce9cf223c7"
  _type = "seagull_autopilot_msgs/AutopilotUserAction"
...
"""
  ...
  __slots__ = ['header','action','on']
  _slot_types = ['seagull_commons_msgs/SeagullHeader','uint8','bool']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(AutopilotUserAction, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_H2B.pack(_x.header.vehicleId, _x.action, _x.on))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.header.vehicleId, _x.action, _x.on,) = _struct_H2B.unpack(str[start:end])

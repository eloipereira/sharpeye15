"""autogenerated by genpy from seagull_autopilot_msgs/AutopilotWPList.msg. Do not edit."""
import sys
...
class AutopilotWPList(genpy.Message):
  _md5sum = "fc2d6f4cb708b1a62a4a5c56c164c7ad"
  _type = "seagull_autopilot_msgs/AutopilotWPList"
...
"""
  ...
  __slots__ = ['header','list','type']
  _slot_types = ['seagull_commons_msgs/SeagullHeader','uint8[]','uint8']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(AutopilotWPList, self).__init__(*args, **kwds)

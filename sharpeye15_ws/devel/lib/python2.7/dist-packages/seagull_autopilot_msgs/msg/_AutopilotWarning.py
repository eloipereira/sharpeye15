"""autogenerated by genpy from seagull_autopilot_msgs/AutopilotWarning.msg. Do not edit."""
import sys
...
class AutopilotWarning(genpy.Message):
  _md5sum = "2df7c3cdabb7bcdfc754ce5b420bfa80"
  _type = "seagull_autopilot_msgs/AutopilotWarning"
...
"""
  __slots__ = ['header','command','code','message']
  _slot_types = ['seagull_commons_msgs/SeagullHeader','uint8','uint8','string']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(AutopilotWarning, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_H2B.pack(_x.header.vehicleId, _x.command, _x.code))
      _x = self.message
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.header.vehicleId, _x.command, _x.code,) = _struct_H2B.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end

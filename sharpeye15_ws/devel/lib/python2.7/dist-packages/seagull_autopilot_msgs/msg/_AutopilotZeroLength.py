"""autogenerated by genpy from seagull_autopilot_msgs/AutopilotZeroLength.msg. Do not edit."""
import sys
...
class AutopilotZeroLength(genpy.Message):
  _md5sum = "09b8db8e6651718203e06a19f8bc5110"
  _type = "seagull_autopilot_msgs/AutopilotZeroLength"
...
"""
  __slots__ = ['header','messageType']
  _slot_types = ['seagull_commons_msgs/SeagullHeader','int8']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(AutopilotZeroLength, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_Hb.pack(_x.header.vehicleId, _x.messageType))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.header.vehicleId, _x.messageType,) = _struct_Hb.unpack(str[start:end])
      return self

...
;//! \htmlinclude AutopilotGimbalPayload.msg.html

(cl:defclass <AutopilotGimbalPayload> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defclass AutopilotGimbalPayload (<AutopilotGimbalPayload>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <AutopilotGimbalPayload>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'AutopilotGimbalPayload)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name seagull_autopilot_msgs-msg:<AutopilotGimbalPayload> is deprecated: use seagull_autopilot_msgs-msg:AutopilotGimbalPayload instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <AutopilotGimbalPayload>))
...
(cl:defmethod len-val ((m <AutopilotGimbalPayload>))
...
(cl:defmethod data-val ((m <AutopilotGimbalPayload>))
  ...
  (data m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <AutopilotGimbalPayload>) ostream)
  "Serializes a message object of type '<AutopilotGimbalPayload>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <AutopilotGimbalPayload>) istream)
  "Deserializes a message object of type '<AutopilotGimbalPayload>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<AutopilotGimbalPayload>)))
  "Returns string type for a message object of type '<AutopilotGimbalPayload>"
  "seagull_autopilot_msgs/AutopilotGimbalPayload")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'AutopilotGimbalPayload)))
  "Returns string type for a message object of type 'AutopilotGimbalPayload"
  "seagull_autopilot_msgs/AutopilotGimbalPayload")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<AutopilotGimbalPayload>)))
  "Returns md5sum for a message object of type '<AutopilotGimbalPayload>"
  "adb78e05c9cc6ce2e481f3c98b9ce89c")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'AutopilotGimbalPayload)))
  "Returns md5sum for a message object of type 'AutopilotGimbalPayload"
  "adb78e05c9cc6ce2e481f3c98b9ce89c")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<AutopilotGimbalPayload>)))
  "Returns full string definition for message of type '<AutopilotGimbalPayload>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'AutopilotGimbalPayload)))
  "Returns full string definition for message of type 'AutopilotGimbalPayload"
  (cl:format cl:nil "seagull_commons_msgs/SeagullHeader header~%uint32 len~%uint8[]  data~%================================================================================~%MSG: seagull_commons_msgs/SeagullHeader~%Header header~%uint16 vehicleId~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <AutopilotGimbalPayload>))
  (cl:+ 0
     (roslisp-msg-protocol:serialization-length (cl:slot-value msg 'header))
     4
     4 (cl:reduce #'cl:+ (cl:slot-value msg 'data) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ 1)))
))
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <AutopilotGimbalPayload>))
  "Converts a ROS message object to a list"
  (cl:list 'AutopilotGimbalPayload
